 ...
 *
 */
public class MySQLDataSource implements DataSourceInterface {

	private final static Logger LOGGER = LogManager.getLogger(MySQLDataSource.class.getName());
	
	/**
	 * 
	 */
	public MySQLDataSource() {
		// LOGGER.debug("MySQLDataSource default constructor.");
		init();
	}
